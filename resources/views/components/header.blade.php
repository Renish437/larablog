             ...
             <nav class="lg:flex-1 lg:min-w-0">
                 <ul
                     ...
                     <li class="group relative shrink-0 lg:py-6.5! z-10" :class="{ 'lg:py-1!': stickyMenu }"
                         ...
                         <ul class="absolute top-full z-10 left-0  bg-gray-50 dark:bg-gray-800 dark:border dark:border-gray-700 shadow-md rounded-md py-2 max-w-max "
                             :class="{ 'flex flex-col': dropdown, 'hidden': !dropdown }" x-show="dropdown"
                             x-transition:enter="transition ease-out duration-200"
                             x-transition:enter-start="opacity-0 translate-y-1"
                             x-transition:enter-end="opacity-100 translate-y-0"
                             ...
                             <li >
                                 <a href="{{ route('blog') }}"
                                     class="block w-full z-10 text-sm hover:text-primary hover:bg-gray-100 dark:hover:bg-gray-700 py-2 px-4 whitespace-nowrap {{ Route::is('blog') ? 'text-primary bg-gray-100 dark:bg-gray-700' : 'dark:text-white' }}">Blog
                                     Details Three</a>
                             </li>
                             <li >
                                 <a href="{{ route('blogs') }}"
                                     class="block w-full z-10 text-sm hover:text-primary hover:bg-gray-100 dark:hover:bg-gray-700 py-2 px-4 whitespace-nowrap {{ Route::is('blogs') ? 'text-primary bg-gray-100 dark:bg-gray-700' : 'dark:text-white' }}">Blog
                                     Archive Page</a>
                             </li>
                         </ul>
                     </li>
