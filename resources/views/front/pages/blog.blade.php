        ...
        <div class="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div class="flex flex-wrap gap-7.5">
            ...
            <div class="xl:max-w-[770px] w-full">
              <img src="{{ asset('front/images/blog-single-03.png') }}" alt="blog" class="w-full mb-10">
                ...
                <div class="flex flex-wrap items-center gap-4">
                  <div class="flex flex-wrap items-center gap-2.5">
                    <h4 class="text-custom-sm">
                      <a href="{{ route('author') }}">Rayna Kenter</a>
                    </h4>
                    <span class="flex w-[3px] h-[3px] rounded-full bg-dark-2"></span>
                    <p class="text-custom-sm">Sep 10, 2025</p>
                    <span class="flex w-[3px] h-[3px] rounded-full bg-dark-2"></span>
              ...
              <div class="px-10 my-8 rounded-md bg-gray py-9">
                <p class="italic font-medium text-center text-dark">
                  “As discussed in the introduction post, one of the best things
                  about Ghost is just how much you can customize so you're not
                  stuck with yet another something unique.”
                </p>

                <a href="{{ route('author') }}" class="flex items-center justify-center gap-3.5 mt-5">
                  <div class="flex w-10 h-10 overflow-hidden rounded-full">
                    <img src="{{ asset('front/images/user-02.png') }}" alt="user">
                  </div>

                  <div>
                    <h4 class="font-medium text-dark text-custom-sm">
                      Rayna Kenter
                    </h4>
                    <p class="text-custom-xs">Founder @jeeb-box</p>
                  </div>
                </a>
              </div>
              ...
              <div class="flex flex-wrap items-center gap-7.5 mt-10">
                <div class="lg:max-w-[360px] w-full">
                  <img src="{{ asset('front/images/blog-single-06.png') }}" alt="blog" class="w-full">
                </div>

                <div class="lg:max-w-[380px] w-full">
                  <h3 class="mb-4 font-bold text-heading-5 text-dark">
                  ...
                  <p class="text-body">
                    As discussed in the introduction post, one of the best
                    things about Ghost is just how much sed placerat dolor
                    volutpat vel.
                  </p>
                </div>
              </div>
              ...
              <div class="mt-10">
                <h2 class="mb-6 font-semibold text-custom-3 text-dark">
                ...
                <ul class="flex flex-col gap-4 mt-5">
                  <li class="flex gap-2 text-body">
                    <span>1.</span>
                    <p>
                      <span class="font-semibold text-dark">Sed ullamcorper dui at risus</span>
                  ...
                  <li class="flex gap-2 text-body">
                    <span>2.</span>
                    <p>
                      <span class="font-semibold text-dark">Everything about your</span>
                  ...
                  <li class="flex gap-2 text-body">
                    <span>3.</span>
                    <p>
                      <span class="font-semibold text-dark">Nulla id quam</span>
              ...
              <div class="flex flex-wrap items-center justify-between gap-10 mt-18">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div class="flex items-center gap-2">
                    <a href="{{ route('blog') }}" class="flex items-center justify-center w-7.5 h-7.5 rounded-full bg-[#364E8F] ease-in duration-200 hover:bg-[#364E8F]/95">
                    ...
                    <a href="{{ route('blog') }}" class="flex items-center justify-center w-7.5 h-7.5 rounded-full bg-[#52A2EC] ease-in duration-200 hover:bg-[#52A2EC]/95">
                      <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="{{ route('blog') }}" class="flex items-center justify-center w-7.5 h-7.5 rounded-full bg-[#B1151D] ease-in duration-200 hover:bg-[#B1151D]/95">
                      <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="flex flex-wrap gap-8 mt-12.5">
                ...
                <div class="max-w-[617px]">
                  ...
                  <div class="flex items-center gap-1.5 mt-5">
                    <a href="{{ route('blog') }}" class="flex items-center justify-center w-7.5 h-7.5 rounded-full hover:bg-gray-2 transition-all duration-200 hover:text-dark">
              ...
              <div class="flex flex-col gap-10">
                ...
                <div class="max-w-[370px] w-full rounded-[10px] border border-gray-3 p-4 sm:p-7.5 lg:p-10">
                  ...
                  <div class="flex flex-col gap-7.5">
                    <!-- post item -->
                    <a href="{{ route('blog') }}" class="group flex gap-6.5">
                ...
                <div class="max-w-[370px] w-full rounded-[10px] border border-gray-3 p-4 sm:p-7.5 lg:p-10">
                  ...
                  <div class="flex flex-col gap-3">
                    <!-- topics item -->
                    <a href="{{ route('blog') }}" class="flex items-center justify-between gap-2 group">
