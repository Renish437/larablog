<x-front-layout>
      ...
      <section class="pt-34 pb-17.5">
        <div class="max-w-[970px] mx-auto px-4 sm:px-8 xl:px-0">
          <h1 class="font-bold text-heading-4 sm:text-heading-3 lg:text-heading-2 text-dark text-center">
            Privacy &amp; Policy
          </h1>
          ...
          <div class="mt-10 sm:mt-15">
            <p class="text-body mb-5">
              ...
              <a href="privacy-policy.html#" class="text-primary underline">network profile.</a>
            </p>
          ...
          <div class="mt-10">
            <h2 class="font-bold text-custom-3 text-dark mb-6">
            ...
            <p class="text-body mb-5">
              ...
              Class aptent taciti sociosqu ad litora torquent per conubia
              nostra, per
              <a href="privacy-policy.html#" class="text-primary underline">inceptos </a>
              himenaeos.
            </p>
          ...
          <div class="mt-10">
            ...
            <ul class="flex flex-col gap-4 mt-5">
              <li class="flex gap-2 text-body">
                <span>1.</span>
                <p>
                  <span class="text-dark font-semibold">Sed ullamcorper dui at risus</span>
              ...
              <li class="flex gap-2 text-body">
                <span>2.</span>
                <p>
                  <span class="text-dark font-semibold">Everything about your</span>
              ...
              <li class="flex gap-2 text-body">
                <span>3.</span>
                <p>
                  <span class="text-dark font-semibold">Nulla id quam</span>
