            ...
            <div class="flex flex-wrap gap-x-7.5 gap-y-9">
                ...
                <div
                    ...
                    <div class="lg:max-w-[536px] w-full">
                        <a href="{{route('blog')}}">
                            <img class="w-full" src="front/images/hero-01.png" alt="hero" />
                        </a>
                    </div>
                ...
                <div
                    ...
                    <div class="lg:max-w-[238px] w-full">
                        <a href="{{route('blog')}}">
                            <img class="w-full" src="front/images/hero-02.png" alt="hero" />
                        </a>
                    </div>
                    ...
                    <div class="lg:max-w-[272px] w-full">
                        ...
                        <div class="flex items-center gap-2.5">
                            <p class="text-sm">
                                <a href="{{route('author')}}">By Adrio Devid</a>
                            </p>
                ...
                <div
                    ...
                    <div class="lg:max-w-[238px] w-full">
                        <a href="{{route('blog')}}">
                            <img class="w-full" src="front/images/hero-03.png" alt="hero" />
                        </a>
                    </div>
        ...
        <div class="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
            ...
            <div x-data="{ selectedCategory: 'All', activeClass: 'bg-dark border-dark text-white', inactiveClass: 'bg-gray border-gray-3 text-dark', }">
                ...
                <div class="flex flex-wrap justify-center gap-4 items-center mb-15">
                    ...
                    <button @click="selectedCategory = 'Culture'"
                        class="rounded-full border py-2.5 px-4.5 font-medium hover:bg-dark hover:border-dark hover:text-white ease-in duration-200"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-11 gap-x-7.5">
                            ...
                            <div class="group">
                                <div class="mb-6 overflow-hidden rounded-[10px] transition-all group-hover:scale-105">
                                    <a href="{{route('blog')}}">
                                        <img src="front/images/blog-01.png" alt="image" class="w-full" />
                                    </a>
                                </div>
                            ...
                            <div class="group">
                                <div class="mb-6 overflow-hidden rounded-[10px] transition-all group-hover:scale-105">
                                    <a href="{{route('blog')}}">
                                        <img src="front/images/blog-02.png" alt="image" class="w-full" />
                                    </a>
                                </div>
                            ...
                            <div class="group">
                                <div class="mb-6 overflow-hidden rounded-[10px] transition-all group-hover:scale-105">
                                    <a href="{{route('blog')}}">
                                        <img src="front/images/blog-03.png" alt="image" class="w-full" />
                                    </a>
                                </div>
                            ...
                            <div class="group">
                                <div class="mb-6 overflow-hidden rounded-[10px] transition-all group-hover:scale-105">
                                    <a href="{{route('blog')}}">
                                        <img src="front/images/blog-04.png" alt="image" class="w-full" />
                                    </a>
                                </div>
                            ...
                            <div class="group">
                                <div class="mb-6 overflow-hidden rounded-[10px] transition-all group-hover:scale-105">
                                    <a href="{{route('blog')}}">
                                        <img src="front/images/blog-05.png" alt="image" class="w-full" />
                                    </a>
                                </div>
                            ...
                            <div class="group">
                                <div class="mb-6 overflow-hidden rounded-[10px] transition-all group-hover:scale-105">
                                    <a href="{{route('blog')}}">
                                        <img src="front/images/blog-06.png" alt="image" class="w-full" />
                                    </a>
                                </div>
                    ...
                    <div x-show="selectedCategory === 'Travel'">
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-11 gap-x-7.5">
                            ...
                            <div class="group">
                                <div class="mb-6 overflow-hidden rounded-[10px] transition-all group-hover:scale-105">
                                    <a href="{{route('blog')}}">
                                        <img src="front/images/blog-07.png" alt="image" class="w-full" />
                                    </a>
                                </div>
                            ...
                            <div class="group">
                                <div class="mb-6 overflow-hidden rounded-[10px] transition-all group-hover:scale-105">
                                    <a href="{{route('blog')}}">
                                        <img src="front/images/blog-08.png" alt="image" class="w-full" />
                                    </a>
                                </div>
                    ...
                    <div x-show="selectedCategory === 'Health'">
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-11 gap-x-7.5">
                            ...
                            <div class="group">
                                <div class="mb-6 overflow-hidden rounded-[10px] transition-all group-hover:scale-105">
                                    <a href="{{route('blog')}}">
                                        <img src="front/images/blog-09.png" alt="image" class="w-full" />
                                    </a>
                                </div>
                    ...
                    <div x-show="selectedCategory === 'Culture'">
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-11 gap-x-7.5">
                            ...
                            <div class="group">
                                <div class="mb-6 overflow-hidden rounded-[10px] transition-all group-hover:scale-105">
                                    <a href="{{route('blog')}}">
                                        <img src="front/images/blog-10.png" alt="image" class="w-full" />
                                    </a>
                                </div>
                            ...
                            <div class="group">
                                <div class="mb-6 overflow-hidden rounded-[10px] transition-all group-hover:scale-105">
                                    <a href="{{route('blog')}}">
                                        <img src="front/images/blog-11.png" alt="image" class="w-full" />
                                    </a>
                                </div>
                            ...
                            <div class="group">
                                <div class="mb-6 overflow-hidden rounded-[10px] transition-all group-hover:scale-105">
                                    <a href="{{route('blog')}}">
                                        <img src="front/images/blog-12.png" alt="image" class="w-full" />
                                    </a>
                                </div>
            ...
            <div class="flex flex-wrap items-center justify-between gap-8 mb-6">
                ...
                <a href="index.html#" class="group text-dark leading-none">
                    <span
                        ...
                        <svg class="fill-current group-hover:rotate-45 transition-all" width="18" height="18"
